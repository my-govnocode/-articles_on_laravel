...
<h5>Самая короткая статья <a href="{{ route('articles.show', $articleMin->code) }}">{{ $articleMin->title }}</a> количество симолов в ней <strong>{{ strlen($articleMin->message) }}</strong></h5><br>
